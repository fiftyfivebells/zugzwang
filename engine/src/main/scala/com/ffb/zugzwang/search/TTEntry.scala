...
object TTEntry:
  ...
  val FlagLower: Long = 1L // Alpha
  val FlagUpper: Long = 2L // Beta

  val None: TTEntry = 0L

  // TODO: replace flag: Long with a defined type
  def apply(move: Move, rawScore: Score, depth: Depth, flag: Long, ply: Ply): TTEntry =
    val storedScore =
    ...
    moveBits | scoreBits | depthBits | flagBits
